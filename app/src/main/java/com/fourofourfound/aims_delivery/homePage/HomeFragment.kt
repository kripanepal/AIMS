...
class HomePage : Fragment() {
     ...
     * The view model responsible for holding the delivery status data for this fragment.
     */
     ...
     * This method toggles the card view when clicked.
     */
            ...
            it.filter { trip -> trip.deliveryStatus == DeliveryStatusEnum.ONGOING }.apply {
                ...
                if (this.isNotEmpty()) {
                    ...
                    val previousDestinationIndex =
                        selectedTrip.sourceOrSite.indexOf(selectedDestination) - 1
                    if (previousDestinationIndex >= 0) deliveryStatusViewModel.previousDestination =
                        selectedTrip.sourceOrSite[previousDestinationIndex]
    ...
    /**
     * Set up adapters
     * This method sets up the adapter for the recycler view.
     * @return
     */
